...
def convert_tflite_to_tflm(tflite_path: str = "model.tflite") -> str:
    ...
    GenerateTFLMHeaderFile(_build_template, operator_list, model_name, hex_array, array_length, path)
...
if __name__ == "__main__":
    # Resolve project root (parent of convto_h/ directory)
    project_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    model_path = os.path.join(project_root, "models", "embedding_model_int8_esp32.tflite")
    convert_tflite_to_tflm(model_path)